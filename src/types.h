...
enum Value : int {
  ...
  QuebisValueMg            = 1225,  QuebisValueEg            = 1420,
  QuekniValueMg            = 1000,   QuekniValueEg           = 1075,
  QuekingValueMg           = 1050,   QuekingValueEg          = 1150,
...
constexpr Value PieceValue[PHASE_NB][PIECE_NB] = {
  { VALUE_ZERO, PawnValueMg, KnightValueMg, BishopValueMg, RookValueMg, QueenValueMg,
    ...
    ArchbishopValueMg, ChancellorValueMg, AmazonValueMg, KnibisValueMg, BiskniValueMg, KnirooValueMg, RookniValueMg, QuerooValueMg, QuebisValueMg, QuekniValueMg, QuekingValueMg, 
  ...
  { VALUE_ZERO, PawnValueEg, KnightValueEg, BishopValueEg, RookValueEg, QueenValueEg,
    ...
    ArchbishopValueMg, ChancellorValueEg, AmazonValueEg, KnibisValueMg, BiskniValueMg, KnirooValueEg, RookniValueEg, QuerooValueEg, QuebisValueEg, QuekniValueEg, QuekingValueEg,
